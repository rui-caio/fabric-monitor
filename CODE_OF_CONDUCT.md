...
Community Impact Guidelines were inspired by [Mozilla's code of conduct enforcement ladder](https://github.com/mozilla/active-communities/blob/master/執行的階梯.md).
